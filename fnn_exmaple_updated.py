...
scenarios = {
    'sa': {'training': 'Training-a1-a3.csv', 'testing': 'Testing-a1-a3.csv', 'mapping': './mapping_sa/'},
    'sb': {'training': 'Training-a1.csv', 'testing': 'Testing-a2-a4.csv', 'mapping': './mapping_sb/'},
    'sc': {'training': 'Training-a1-a2.csv', 'testing': 'Testing-a1-a2-a3.csv', 'mapping': './mapping_sc/'},
}
scenario = input ('Please enter the scenario you would like to run - either sa, sb or sc:')
TrainingData = scenarios[scenario.lower()]['training']
TestingData  = scenarios[scenario.lower()]['testing']
mapping_path = scenarios[scenario.lower()]['mapping']
...
print('training data: {}'.format(TrainingData))
print('testing data: {}'.format(TestingData))
import data_preprocessor as dp
X_train, y_train = dp.get_processed_data(TrainingData, mapping_path, classType ='binary')
X_test,  y_test  = dp.get_processed_data(TestingData,  mapping_path, classType ='binary')
